...
BEGIN
    -- ==========================================================================================
    -- FECHA: 17-10-2025
    -- DESCRIPCIÓN: SP de prueba para extraer Contratos de los últimos 5 días y la Cédula más 
    --              reciente de los clientes asociados, según la lógica solicitada.
    -- ==========================================================================================

    SET NOCOUNT ON;

    -- Declaramos las variables a utilizar
    DECLARE @DIAS_ATRAS numeric(3) = -5;
    DECLARE @FechaDesde DATE = DATEADD(day, @DIAS_ATRAS, GETDATE());
    ...
    -- PASO 1: Obtener los Contratos de Axentria de los últimos 5 días.
    SELECT
    ...
    -- PASO 2: Obtener la cédula más reciente para los clientes de los CONTRATOS encontrados.
    
    -- 2.1: Traer todas las cédulas de los clientes desde la tabla pre-calculada, filtrando nulos.
    SELECT
        base.*
