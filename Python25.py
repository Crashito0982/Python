...
BEGIN
    ...
    DECLARE @FechaFiltroDesde_YYYYMMDD VARCHAR(8) = CONVERT(VARCHAR(8), @FechaFiltroDesde, 112); -- Variable para comparación segura
    ...
    -- PASO 3: Filtrar aplicando el filtro de fecha sobre el evento.
    SELECT evt.docid
    ...
    WHERE 
        ...
        -- AND doc.docedf >= @FechaFiltroDesde_YYYYMMDD; -- CORRECCIÓN: Se elimina este filtro por ser demasiado restrictivo.
